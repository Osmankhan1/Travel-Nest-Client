...
const Packege = () => {
    ...
    return (
        <div className="mt-16 md:mt-40">
            ...
            <p className="md:w-[500px] px-10 md:px-0 text-center m-auto mt-4">It is a long established fact that a reader will be distracted by the readable content of a page.</p>
            <div className="max-w-7xl mx-auto p-10 md:p-10 md:gap-4 lg:p-0  grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:mt-20">
                {
                    packeges &&
