...
const Packege = () => {
    ...
    return (
        <div className="mt-40">
            <h1 className='text-[42px] font-bold text-center '>Our Awesome <span className="text-[#FF3811]">Packages</span></h1>
            ...
            <div className="max-w-7xl mx-auto  grid md:grid-cols-3 gap-4 mt-20">
                {
                    packeges &&
