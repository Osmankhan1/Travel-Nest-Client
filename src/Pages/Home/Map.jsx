...
const Map = () => {
    return (
        <div className='mt-16 md:mt-48 max-w-7xl md:p-10 mx-auto'>
            <h1 className='text-[25px] md:text-[42px] font-bold text-center '>Our <span className='text-[#FF3811]'>Location</span></h1>
            <p className='text-center md:w-[500px] px-10 md:px-0 m-auto mt-5'> If you could provide me with that information, I can assist you in generating a description and potentially even include a map or directions to the hotel's location.</p>

            <div className='md:flex p-5 md:p-0 md:mt-20 '>
                ...
                <div className='md:w-1/3 mt-20'>
                    ...
                    <div className='mt-8 ml-20 md:ml-[115px]'>
