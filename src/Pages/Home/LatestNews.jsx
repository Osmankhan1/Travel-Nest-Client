...
const LatestNews = () => {
    ...
    return (
        <div className="mt-16 md:mt-48">
            ...
            <p className='text-center md:w-[500px] px-10 md:px-0 m-auto mt-5'>It is a long established fact that a reader will be distracted by the readable content of a page.</p>
